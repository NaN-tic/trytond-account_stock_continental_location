...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-account_stock_continental_location',
    download_url='https://github.com:nantic/trytond-account_stock_continental_location.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-account_stock_continental_location.git'
    },
    classifiers=[
